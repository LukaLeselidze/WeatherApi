...
function FetchApis({ name }) {
    ...
    const cityWeatherUrl = `https://api.openweathermap.org/data/2.5/weather?q=Bakuriani&appid=029cc9c1b544f341ab25d75d65e9f4cf`
        ...
        <>
            <div className='city-container'>
                ...
                <div className='temp-cont'>
                    ...
                    <span>o</span>
                    <img src={searched && cityData.weather[0].main === 'Clear' ? sunny : rainy}></img>
                </div>
            </div>
